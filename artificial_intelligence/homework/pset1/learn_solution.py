...
# Given X, an n x d matrix, where n is the number of samples and d the dimensionality of each sample, and b, a bandwidth,
# X[i,:] is the i-th sample
# return a *function* that maps a single input vector into a vector of features, the vector should be of np.matrix class and have shape (1,d)
def RBFs(X, b):
    # Your code here
    pass
    ...
    def featvec(x):
        ...
        # print('retval.shape',retval.shape)
